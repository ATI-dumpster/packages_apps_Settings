...
object EverestSpecUtils {
    ...
    fun getTotalInternalMemorySize(context: Context): String {
        val flagValue = getSystemProperty("ro.everest.storage") 
        if (flagValue.isNotEmpty()) return flagValue
    ...
    fun getTotalRAM(context: Context): String {
        val flagValue = getSystemProperty("ro.everest.ram") 
        if (flagValue.isNotEmpty()) return flagValue
    ...
    fun getProcessorModel(context: Context): String {
        val flagValue = getSystemProperty("ro.everest.cpu") 
        if (flagValue.isNotEmpty()) return flagValue
    ...
    fun getScreenRes(context: Context): String {
        val flagValue = getSystemProperty("ro.everest.screen_res") 
        if (flagValue.isNotEmpty()) return flagValue
    ...
    fun getBatteryCapacity(context: Context): String {
        val flagValue = getSystemProperty("ro.everest.battery")
        if (flagValue.isNotEmpty()) return flagValue
